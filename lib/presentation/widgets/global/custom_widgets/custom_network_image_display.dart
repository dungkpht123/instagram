    ...
    return OctoImage(
      ...
      placeholderBuilder: (context) {
        if (widget.blurHash.isNotEmpty) {
          // Replace this section with your BlurHash placeholder generation logic.
          // You need to create or use a widget that generates a BlurHash placeholder.
          // For example:
          // return YourBlurHashPlaceholder(
          //   blurHash: widget.blurHash,
          //   fit: BoxFit.cover,
          // );
          // Replace `YourBlurHashPlaceholder` with the actual widget you create.
          // For generating BlurHash, refer to the documentation of the package you use.
          // Currently, Flutter's `octo_image` doesn't support BlurHash as a placeholder directly.
          return Container(); // Placeholder until you implement BlurHash functionality.
        } else {
