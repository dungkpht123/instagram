...
class SheetExtent {
  final bool isDialog;
  final SlidingSheetScrollController? controller;
...
class SlidingSheetScrollController extends ScrollController {
  final SlidingSheetState sheet;
  SlidingSheetScrollController(this.sheet);
...
class SlidingSheetScrollPosition extends ScrollPositionWithSingleContext {
  ...
  SlidingSheetState get sheet => scrollController.sheet;
